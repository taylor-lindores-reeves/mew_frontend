...
class Page_Page extends external_react_["Component"] {
  render() {
    return __jsx(external_styled_components_["ThemeProvider"], {
      theme: theme
    }, __jsx(external_styled_reset_["Reset"], null), __jsx(GlobalStyle, null), __jsx(external_react_helmet_["Helmet"], null, __jsx("title", null, "Digital Speed"), __jsx("meta", {
      charset: "UTF-8"
    }), __jsx("meta", {
      ...
      rel: "stylesheet"
    })), __jsx(StyledPage, null, this.props.children));
  }
...
function createClient({
  ...
  return new external_apollo_boost_default.a({
    uri: false ? undefined : process.env.GRAPHQL_ENDPOINT,
    request: operation => {
